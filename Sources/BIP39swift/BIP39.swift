...
public class BIP39 {
    ...
    */
    ...
    static public func mnemonicsToEntropy(_ mnemonics: String, language: BIP39Language = BIP39Language.english) -> Data? {
        ...
        guard wordList.count >= 12 && wordList.count <= 24 && wordList.count.isMultiple(of: 3)  else {return nil}
        var bitString = ""
    ...
    static public func seedFromMnemonics(_ mnemonics: String, password: String = "", language: BIP39Language = BIP39Language.english) -> Data? {
    ...
    static public func seedFromEntropy(_ entropy: Data, password: String = "", language: BIP39Language = BIP39Language.english) -> Data? {
        ...
        return BIP39.seedFromMnemonics(mnemonics, password: password, language: language)
    }
}
